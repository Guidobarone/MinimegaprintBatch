...
public enum ResourcePath {
    ...
    FileuploaderGetProductAttachments("fileuploader.getProductAttachments"),
    FileuploaderGetMediaPath("fileuploader.getMediaPath"),
    ...
    SalesOrderCreditMemoList("sales_order_creditmemo.list"),
    SalesOrderCreditMemoInfo("sales_order_creditmemo.info"),
    SalesOrderCreditMemoCreate("sales_order_creditmemo.create"),
    SalesOrderCreditMemoAddComment("sales_order_creditmemo.addComment"),
    SalesOrderCreditMemoCapture("sales_order_creditmemo.cancel"),
