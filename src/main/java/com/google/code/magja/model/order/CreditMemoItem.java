...
public class CreditMemoItem extends BaseMagentoModel {

	private static final long serialVersionUID = 3855727300707154464L;
	private String sku;
    private String name;
    ...
    public String toString() {
        return "CreditMemoItem [name=" + name + ", orderItemId=" + orderItemId
