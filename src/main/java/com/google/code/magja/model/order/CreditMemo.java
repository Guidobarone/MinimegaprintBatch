...
public class CreditMemo extends BaseMagentoModel {

	private static final long serialVersionUID = -6441125539636507302L;
	private Integer customerId;
    private String orderNumber;
    private Double totalQty;
    private Integer shipmentId;
    private List<CreditMemoItem> items = new ArrayList<CreditMemoItem>();
     ...
     */
    public void setCreditMemoId(Integer shipmentId) {
     ...
     * @return the items
     */
    public List<CreditMemoItem> getItems() {
        return items;
    }
     ...
     */
    public void setItems(List<CreditMemoItem> items) {
        this.items = items;
    }
    ...
    public String toString() {
        return "CreditMemo [customerId=" + customerId + ", items=" + items
