...
import com.google.code.magja.service.fileuploader.FileuploaderRemoteServiceImpl;
import com.google.code.magja.service.order.CreditMemoRemoteService;
import com.google.code.magja.service.order.CreditMemoRemoteServiceImpl;
...
public abstract class RemoteServiceFactory {
    ...
    /**
     * @return the invoiceRemoteService
     */
    ...
    /**
     * @return the creditMemoRemoteService
     */
    public static CreditMemoRemoteService getCreditMemoRemoteService() {
        return getCreditMemoRemoteService(null);
    }
    ...
    public static CreditMemoRemoteService getCreditMemoRemoteService(
        ...
        CreditMemoRemoteService creditMemoRemoteService = new CreditMemoRemoteServiceImpl();
        creditMemoRemoteService.setSoapClient(MagentoSoapClient
                .getInstance(soapConfig));

        return creditMemoRemoteService;
    }
    
    /**
     * @return the registryRemoteService
     */
    ...
    /**
     * @return the fileuploaderRemoteService
     */
    public static FileuploaderRemoteService getFileuploaderRemoteService() {
        return getFileuploaderRemoteService(null);
    }
    ...
    public static FileuploaderRemoteService getFileuploaderRemoteService(
    	...
    	FileuploaderRemoteService fileuploaderRemoteService = new FileuploaderRemoteServiceImpl();
        fileuploaderRemoteService.setSoapClient(MagentoSoapClient
                .getInstance(soapConfig));

        return fileuploaderRemoteService;
    }
}