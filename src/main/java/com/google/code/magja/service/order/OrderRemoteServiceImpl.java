...
import com.google.code.magja.model.order.Payment;
...
public class OrderRemoteServiceImpl extends GeneralServiceImpl<Order> implements
    ...
    private Order buildOrderObject(Map<String, Object> attributes)
        ...
        if (attributes.get("payment") != null) {
            ...
            Map payMap = (Map) attributes.get("payment");
            payment.setId(new Integer((String) payMap.get("payment_id")));
            if (payMap.get("method") != null)
            	payment.setMethod((String) payMap.get("method"));
