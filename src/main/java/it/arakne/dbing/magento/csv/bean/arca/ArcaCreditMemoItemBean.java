...
import com.google.code.magja.model.order.CreditMemoItem;

public class ArcaCreditMemoItemBean {
	...
	private final static Logger LOGGER = Logger.getLogger(ArcaCreditMemoItemBean.class.getName());

	public ArcaCreditMemoItemBean() {
		super();
	}

	public ArcaCreditMemoItemBean(Map<String,String> item) {
		super();
...
//		this.prezzoun = StringUtil.cutStringRight(NumberUtil.convert2Price(item.get("price")), 8);
...
//		this.prezzotot = StringUtil.cutStringRight( NumberUtil.convert2Price(new Double(price_tmp * qty_tmp).toString()) , 8);
	...
	public ArcaCreditMemoItemBean(CreditMemoItem item) {
		super();
